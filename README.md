...
```bash
# marketplace 등록
/plugin marketplace add bunnie198/claude-workflows
...
| 스킬 | 실행 | 설명 |
|------|------|------|
| **test-evolve** | `/claude-workflows:test-evolve` | 버그 → 관점 분석 → 전략 진화 → 동기화 |
| **test-audit** | `/claude-workflows:test-audit` | 7관점 테스트 커버리지 감사 |
