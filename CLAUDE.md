...
4. **플러그인 동기화**: 새 관점이 발견되면 `bunnie-workflows/strategy/perspectives.md`에 추가하고 플러그인 레포에 커밋/푸시.
...
프로젝트에 CLAUDE.md 테스트 관점 목록이 아직 없으면, `bunnie-workflows/strategy/perspectives.md`의 기본 관점을 참조하여 초기화를 제안.
